...
import com.remi.alarmclock.xtreme.free.helpers.LINK_APP
import java.io.*
import java.util.*
...
object Utils {
    ...
    fun createNotification(context: Context, importance: Int, channel: String) {
    ...
    fun makeVibrate(context: Context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            vibrator = (context.getSystemService(Service.VIBRATOR_MANAGER_SERVICE) as VibratorManager).defaultVibrator
